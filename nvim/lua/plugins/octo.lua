return {
  ...
  keys = {
    ...
    { "<leader>oa", "", desc = "+actions" },
    { "<leader>oac", "<cmd>Octo actions<CR>", desc = "Run actions" },
    
    { "<leader>oc", "", desc = "+comment/create" },
    { "<leader>oci", "<cmd>Octo issue create<CR>", desc = "Create issue" },
    { "<leader>ocp", "<cmd>Octo pr create<CR>", desc = "Create PR" },
    
    { "<leader>ot", "", desc = "+thread" },
